...
public class NfcVUtils {
    ...
    public NfcVUtils(NfcV mNfcV) throws IOException {
        ...
        this.UID = DataUtils.saveHex2String(uid);
        getInfoRmation();
    }
    ...
    private byte[] getInfoRmation() throws IOException {
        ...
        AFI = DataUtils.saveHex2String(new byte[]{infoRmation[11]});
        DSFID = DataUtils.saveHex2String(new byte[]{infoRmation[10]});
        return infoRmation;
    }
    ...
    public String readOneBlock(int position) throws IOException {
        ...
        if (res[0] == 0x00) {
            ...
            return DataUtils.saveHex2String(block);
        }
        return null;
    }
